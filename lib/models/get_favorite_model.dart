...
//
//     final favoritemModel = favoritemModelFromJson(jsonString);

import 'dart:convert';

List<FavoritemModel> favoritemModelFromJson(String str) => List<FavoritemModel>.from(json.decode(str).map((x) => FavoritemModel.fromJson(x)));

String favoritemModelToJson(List<FavoritemModel> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
