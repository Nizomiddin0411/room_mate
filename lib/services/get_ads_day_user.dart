    ...
    try {
      var response = await http.get(
          Uri.parse(
            ...
            '${Const.baseUrl}api/advertising/get-advertising?stay_university_id=$univerId&university_id=$univerId&house_type=$houseType&room_count=$roomCount&rent_type=1&subway=$subway&cost_from=$costFrom&cost_to=$costTo&type=2&roommate_gender=0&district_id=$districtId',
          ),
          headers: {
