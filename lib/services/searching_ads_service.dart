...
class SearchingAdsService{
  Future<List<SearchingStudentAll>?> fetchSearchingAds( ) async{
    try{
      ...
      var _response = await http.get(Uri.parse('http://164.68.114.231:8081/roommate/backend/web/api/advertising/get-advertising?region_id=0&district_id=0&university_id=0&faculty_id=0&course=1&live_with_owner=0&house_type=1&room_count=0&rent_type=1&subway=0&cost_from=100&cost_to=160000&type=0&roommate_gender=0'),
        // headers: {
