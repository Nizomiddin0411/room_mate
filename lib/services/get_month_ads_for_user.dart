...
class GetMonthAdsUser {
  Future<List<AllAdsModel>> fetchAdsMonthUser(
      String regionId,
      String districtId,
      String univerId,
      // String course,
    ...
    try {
      var response = await http.get(
          ...
          'http://164.68.114.231:8081/roommate/backend/web/api/advertising/get-advertising?stay_university_id=$univerId&university_id=$univerId&house_type=$houseType&room_count=$roomCount&rent_type=2&subway=$subway&cost_from=$costFrom&cost_to=$costTo&type=2&roommate_gender=0&district_id=$districtId'
          ),
          headers: {
