  ...
  Future<List<DaysKvModel>?> fetchDays() async {
    try {
      var response = await http.get(Uri.parse(
          '${Const.baseUrl}api/advertising/get-advertising?region_id=1&district_id=1&university_id=1&faculty_id=1&course=1&live_with_owner=1&house_type=1&room_count=0&rent_type=1&subway=1&cost_from=100&cost_to=160000'));
