  ...
  Future<List<AllAdsModel>> fetchADS(
    ...
    try {
      ...
      var response = await http.get(
          ...
          '${Const.baseUrl}api/advertising/get-advertising?stay_university_id=$univerId&university_id=$univerId&house_type=$houseType&room_count=$roomCount&rent_type=$rentType&subway=$subway&cost_from=$costFrom&cost_to=$costTo&type=1&roommate_gender=0&district_id=$districtId'
          ),
          headers: {
